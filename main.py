...
def prepare_total_sales():
    ...
    global amazon_sales, amazon_inventory, total_sales, max_sales_date_str, sku_isr
...
def prepare_forecast():
    global forecast, dimensions, nearest_event, sku_results, file_date
